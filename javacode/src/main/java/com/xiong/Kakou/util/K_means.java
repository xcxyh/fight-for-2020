...
public class K_means {
    ...
    public void printDataArray(ArrayList<float[]> dataArray,
        ...
        for (int i = 0; i < dataArray.size(); i++) {
            System.out.println("print:"+dataArray.get(i)[2] +"(" + dataArray.get(i)[0] + "," + dataArray.get(i)[1]+")");
        }
        System.out.println("===================================");
    }

    public  List<String[]> getNodeClusterMap(ArrayList<float[]> dataArray,
                                  String dataArrayName) {
        ...
        System.out.println(dataArrayName + ": ");
        for (int i = 0; i < dataArray.size(); i++) {
            result.add(new String[]{dataArray.get(i)[2] + "", dataArrayName});
